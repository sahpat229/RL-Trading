...
class TradingStateModel():
    ...
    def asset_features_shape(self):
        return (self.datacontainer.num_assets, self.history_length, self.datacontainer.num_asset_features, )

    @property
    def portfolio_features_shape(self):
        return (self.datacontainer.num_assets, 1, 1, )

    @property
    def observation_space(self):
        return np.zeros([self.datacontainer.num_flattened_features(self.history_length)])
