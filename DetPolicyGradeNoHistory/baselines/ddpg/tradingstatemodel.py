...
class TradingStateModel():
    ...
    @property
    def asset_features_shape(self):
        return (self.datacontainer.num_assets, self.datacontainer.num_asset_features, )

    @property
    def portfolio_features_shape(self):
        return (self.datacontainer.num_assets, )

    @property
    def observation_space(self):
        return np.zeros(self.datacontainer.num_flattened_features)
    
    @property
    def action_space(self):
        return np.zeros(self.datacontainer.num_assets)
    ...
    def reset(self):
        ...
        initial_portfolio = np.ones(self.datacontainer.num_assets) / self.datacontainer.num_assets
